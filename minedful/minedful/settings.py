"""
Django settings for minedful project.
...
SECRET_KEY = 'django-insecure-g=_y4keuy1dd!@(a)^4%uacv#v!g@0cyl4ifax=7jgn+)x-f5#'
...
WSGI_APPLICATION = 'minedful.wsgi.application'
